...
public class MovieTriviaGame {
	
	private Session session;
    private MovieTriviaUserData gameData;

    public MovieTriviaGame() {
    }
     ...
     */
    public static MovieTriviaGame newInstance(Session session, MovieTriviaUserData gameData) {
    ...
    public MovieTriviaUserData getGameData() {
        return gameData;
    }

    public void setGameData(MovieTriviaUserData gameData) {
